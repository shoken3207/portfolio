...
const Header = () => {
  ...
  return (
    <div>
      ...
      <header
        className={`fixed top-0 w-full bg-white py-4 border-t-[3px] border-blue-400 shadow-sm shadow-blue-400/20`}
      >
        <div className=" w-11/12 mx-auto max-w-3xl flex justify-between items-center transition-opacity hidden]">
          ...
          >
            <img className="w-10" src="/icons/menu-svgrepo-com.svg" alt="" />
          </div>
        </div>
      </header>
    </div>
