        ...
        >
          <LinkWrap href={`/work/${work.id}`}>
            <div className=" overflow-hidden w-full aspect-w-16 aspect-h-9 relative group">
              <div className="w-full h-full absolute top-0 left-0 z-10  transition-all duration-[400ms] pointer-events-none bg-black bg-opacity-0 group-hover:bg-opacity-30"></div>
              <img
